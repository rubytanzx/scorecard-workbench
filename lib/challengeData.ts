...
export const challengeSets: ChallengeSet[] = [
  {
    ...
    summary: "Underfunded primary care creates catastrophic out-of-pocket spending. Financing reforms show fastest progress where IDA support is concentrated.",
    padCount: 218,
    isrCount: 1842,
    icrCount: 41,
    evidenceCount: 142,
  ...
  },
  {
    ...
    summary: "Siloed registries exclude the bottom quintile from formal protection. Digital payment rail integration has cut exclusion errors by 30% in Sub-Saharan Africa pilots.",
    padCount: 174,
    isrCount: 1612,
    icrCount: 38,
    evidenceCount: 98,
  ...
  },
  {
    ...
    summary: "Climate shocks drive distress asset sales faster than aid can scale. Shock-responsive cash transfers indexed to climate signals show the fastest recovery rates.",
    padCount: 145,
    isrCount: 890,
    icrCount: 22,
    evidenceCount: 61,
  ...
  },
  {
    ...
    summary: "Electricity access grows at 2.1% p.a., half the rate needed for FY30 targets. IDA guarantees and DFI co-investment have unlocked $3.2B in private capital since FY22.",
    padCount: 203,
    isrCount: 1340,
    icrCount: 31,
    evidenceCount: 87,
  ...
  },
  {
    ...
    summary: "Mobile money ownership is up 14% but urban-concentrated, with the rural gap widening. Regulatory sandboxes and agent network investments drive the most inclusive expansion.",
    padCount: 189,
    isrCount: 1120,
    icrCount: 27,
    evidenceCount: 74,
  ...
  },
  {
    ...
    summary: "Post-harvest losses average 32% with no improvement since FY23. IDA warehouse receipt systems and agri-credit have doubled smallholder value chain participation in pilots.",
    padCount: 134,
    isrCount: 760,
    icrCount: 19,
    evidenceCount: 53,
  ...
  },
  {
    ...
    summary: "Legal identity coverage is stagnant at 61% across 31 countries. Digital ID linked across health, education, and social protection shows the highest cross-sector multiplier.",
    padCount: 267,
    isrCount: 1980,
    icrCount: 52,
    evidenceCount: 112,
  ...
  },
  {
    ...
    summary: "Only 6 of 16 countries link civil registration to social protection. IDA data platform support has cut targeting errors by 28% in four early-adopter countries.",
    padCount: 112,
    isrCount: 620,
    icrCount: 14,
    evidenceCount: 44,
  ...
  },
  {
    ...
    summary: "Tax-to-GDP ratios are declining in 9 of 14 countries, compressing fiscal space. IDA e-procurement support has cut cost overruns by 22% and raised SME participation by 18%.",
    padCount: 96,
    isrCount: 540,
    icrCount: 11,
    evidenceCount: 38,
